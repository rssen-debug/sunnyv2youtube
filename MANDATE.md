...
3. **Captions v2** — kinetic typography, Archivo Black, keyword-highlight (röda nyckelord),
   rotations-jitter
3b. **make_video.py** — generisk maskin: JSON-config i `EPISODES/` -> full render + verify.
   Använd denna som STANDARDVÄG. Bygg endast custom-builder när configen inte räcker.
